...
class DPPify:
    ...
    def _generate_dpp_metadata(self, topic_name: str, total_questions: int, question_type: str, difficulty_level: str, api_key: str, language: str,additional_instruction: str,answer_key: bool) -> dict:
        """
...
WARNING: Any deviation from specifications or additional instructions will invalidate the output. Prioritize instruction compliance over creativity."""
        ...
        agent = Agent(
            model=Cerebras(id="qwen-3-235b-a22b-thinking-2507", api_key=api_key,max_completion_tokens=40000),
        ...
        if answer_key:
            ...
            answers_list = [q.actual_answer for q in response.questions]
            return {
    ...
    def run(self, topic_name: str, question_type: str, total_q: int, level: str, api_key: str,answer_key: bool,dpp_language: str = "English",additional_instruction: str = "") -> str:
        """
        ...
        try:
            ...
            if answer_key:
                pdf_path = create_dpp_pdf(
                    ...
                    answer_key=dpp_metadata["answers"],
                )
            else:
                pdf_path = create_dpp_pdf(
                    topic_name=dpp_metadata["topic_name"],
